...
![余烬之境 V0.2.2 城镇经营界面：资源库存、建筑与发展操作](docs/images/城镇经营.png)

从采集和建设起步，扩建城镇，为研究、锻造与出征积累物资。

**队伍养成**

![余烬之境 V0.2.2 队伍养成界面：旅人名册、角色培养、装备与锻造](docs/images/队伍养成.png)
...
![余烬之境 V0.2.2 远征地图界面：地区选择、据点目标与出征准备](docs/images/远征地图.png)

选择已发现的地图与据点，准备出征，也能返回已经击败的守敌刷取装备。

**首领战斗**

![余烬之境 V0.2.2 首领战斗界面：敌人意图、角色生命与技能行动](docs/images/首领战斗.png)
