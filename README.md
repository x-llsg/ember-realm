...
**V0.3.1 界面修复：地图、出发费用与操作各有空间，按窗口大小调整布局。**

![余烬之境 V0.3.1 远征地图：地区与支线、守敌目标、完整的出发安排](docs/images/远征布局.png)

**V0.3.0 新增：六章支线探索、遗物与地区设施。** 以下截图来自实际游戏页面。

**地图上的另一条路**

![余烬之境 V0.3.0 支线地点：现场状况、强攻与巧解、出行准备](docs/images/支线探索.png)

每章发现两处地点，读清现场状况，再选择迎战守敌或消耗物资巧解。首探取回独特遗物；掌握处理方式后，可安排带预算与停止条件的重复探索。
