...
const html=`<!doctype html><html lang="zh-CN" class="dark"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#0c1018"><title>余烬之境 · V${version}</title><meta name="description" content="穿越异世，建造城镇、雇佣冒险者，走向魔王、巨龙与神明的终局。"><style>${css.replaceAll('</style','<\\/style')}</style></head><body><div id="root"></div><noscript>请在浏览器设置中允许 JavaScript，以继续这段旅程。</noscript><script>${js.replaceAll('</script','<\\/script')}</script></body></html>`;
