...
export const TALENTS: readonly TalentDefinition[] = [
  ...
  },
  {
    ...
    name: '草药师',
    rarity: 1,
    text: '全队补给治疗 +5个百分点（同名不叠加）；自身攻击 -5%。',
    stats: { attack: -0.05 },
  },
  {
    id: 'scholar',
  ...
  },
  {
    ...
    name: '血刃誓约',
    rarity: 4,
    text: '攻击 +18%、暴击 +8个百分点；生命 -15%、治疗效果 -20%。',
  ...
  },
  {
    ...
    name: '不动之壁',
    rarity: 4,
    text: '生命 +20%、护盾效果 +25%；攻击 -15%、闪避 -5个百分点。',
  ...
  },
  {
    ...
    name: '陨星之心',
    rarity: 5,
    text: '暴击 +15个百分点、暴伤 +40%、穿甲 +10个百分点；生命 -20%、三种元素抗性 -10个百分点。',
    stats: {
      crit: 0.15,
      critDamage: 0.4,
      pierce: 0.1,
  ...
  },
  {
    ...
    name: '炽血',
    rarity: 4,
    text: '攻击 +12%、火抗 +25个百分点；暗抗 -15个百分点。',
