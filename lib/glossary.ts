...
export const HELP = {
  ...
  affix: {
    title: '装备词条',
    body: `每件新装备从 ${G.AFFIXES.length} 种词条中等机会抽取一种。锋锐提供额外攻击，坚韧提供额外生命，二者乘装备完整数值倍率；其余词条按标明的固定值加算。暴击率、闪避率、穿甲和抗性上的百分比直接加减当前数值，例如 10% 暴击率获得 +8% 后变为 18%。支付 20 × 装备阶级的锻造尘可直接选择另一词条，不需要再次随机。词条已经计入装备详情与角色属性。`,
  },
  dust: {
    title: '锻造尘',
